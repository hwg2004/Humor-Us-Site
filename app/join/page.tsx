...
const faqs = [
  {
    ...
    a: "Auditions will be Wednesday, September 16 and Thursday, September 17 from 4:30-6:30. We offer 2 different sessions (of which you only have to attend one), that way you are sure to find one that fits your schedule.",
  },
  {
      ...
      <section className="px-6 pt-16 md:px-10">
        <div className="mx-auto max-w-[1000px]">
          ...
          <p className="hu-body mt-8 max-w-[70ch] !text-[21px] !leading-[1.55]">
            ...
            16 OR Thursday, September 17 from 4:30 - 6:30pm in Uris Hall G01! Anyone can audition
